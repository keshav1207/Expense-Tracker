...
router.route('/api/createTransaction/:userId').post(controller.createTransaction);
...
router.route('/api/loginUser').post(controller.loginUser);
router.route('/api/logOutUser').post(controller.logOutUser);
